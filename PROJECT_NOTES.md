...
- `docs/rcon-admin-controls.md` captures the RCON investigation and recommends a future backend-only, whitelist-based, allocation-time configuration flow using a Kubernetes Secret for the RCON password
